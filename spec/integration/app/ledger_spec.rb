...
module ExpenseTracker
  RSpec.describe Ledger, :aggregate_failures, :db do # will not abort example on first failure
    ...
    describe '#record' do
      ...
      context 'when the expense lacks a payee' do
        it 'rejects the expense as invalid' do
          ...
          expect(result.errors).to include('Invalid expense: `payee` is required')
